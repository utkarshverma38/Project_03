...
public class MarksheetModelHibImp implements MarksheetModelInt {
	...
	/**
	 * find  Marksheet record by Primary key
	 *
	 */
	...
	/**
	 * find  Marksheet record by Rollno
	 *
	 */
